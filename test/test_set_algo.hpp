...
namespace zstl
{
    ...
    TEST(SetAlgoTest, SetIntersection)
    {
        ...
        vector<int> b{2, 3, 5, 6};
        vector<int> result(4);
        zstl::set_intersection(a.begin(), a.end(), b.begin(), b.end(), result.begin());
    ...
    TEST(SetAlgoTest, SetSymmetricDifference)
    {
        ...
        vector<int> b{2, 3, 5, 6};
        vector<int> result(8);
        zstl::set_symmetric_difference(a.begin(), a.end(), b.begin(), b.end(), result.begin());
    ...
    TEST(SetAlgoTest, StringSetUnion)
    {
        ...
        zstl::set_union(a.begin(), a.end(), b.begin(), b.end(), result.begin());
